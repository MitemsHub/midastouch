...
**server `Upcomers-Server`, login `1293766`, password `<REDACTED — rotated 2026-09-20>`** (include the
...
```bash
MT5_PASSWORD='<REDACTED>' .venv/Scripts/python.exe scripts/venue_probe.py \
...
- Code: `src/midas_prop/risk/upcomers_rules.py`,
