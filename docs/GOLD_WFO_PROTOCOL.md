...
* Folds are **contiguous calendar blocks of 8 days** starting after warm-up
  (`WF_FOLD_DAYS=8`, the frozen value used by `scripts/walkforward_v75.py`).
...
Adapted verbatim from the V1–V6 block in `scripts/walkforward_v75.py`, with V4 replaced by
